...
Used code for:
    - classes: Client
    - functions: send_all(), send_all_json, read_ws(), and subscribe_socket()
Author: Abram Hindle / Hazel Victoria Campbell
Author Github: https://github.com/abramhindle
Author Github: https://github.com/hazelybell
